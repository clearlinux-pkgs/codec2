...
Source0  : https://github.com/drowe67/codec2/archive/v1.1.0/codec2-1.1.0.tar.gz
...
%prep
%setup -q -n codec2-1.1.0
cd %{_builddir}/codec2-1.1.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1683296842
mkdir -p clr-build
pushd clr-build
...
%files dev
%defattr(-,root,root,-)
/V3/usr/lib64/libcodec2.so
/V4/usr/lib64/libcodec2.so
